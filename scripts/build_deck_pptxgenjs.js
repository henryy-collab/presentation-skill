...
const PRESET_TREATMENTS = {
  ...
  'first-page-sales': {
    page_system: 'editorial-field',
    structural_motif: 'first-page-rule',
    header_mode: 'stack',
    title_layout: 'fp-cover',
    title_motif: 'none',
    section_motif: 'none',
    timeline_mode: 'open-events',
    matrix_mode: 'open-quadrants',
...
const GRAMMAR_BY_PRESET = {
  ...
  'first-page-sales': 'consulting-answer-pyramid',
};
...
const STYLE_ENUM_VALUES = {
  ...
  table_treatment: new Set(['standard', 'compact-ledger', 'readout-sidecar', 'decision-matrix', 'journal-grid', 'light-ledger', 'dark-ledger']),
